...
# Title: Lab1_part2_Muestreo
# Author: Carlos_Molinares_Oscar_Meza_C1C_G1
...
class Lab1_2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab1_part2_Muestreo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab1_part2_Muestreo")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab1_2")
        ...
        self._rap_range = Range(0.5, 5, 0.5, 1, 200)
        self._rap_win = RangeWidget(self._rap_range, self.set_rap, "Rapidez", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._rap_win)
        self._fc_range = Range(100, 21000, 10, 1500, 200)
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "Frequencia central", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._Vol_range = Range(0, 100, 1, 1, 200)
        ...
        self._f_corte_win = RangeWidget(self._f_corte_range, self.set_f_corte, "Frequencia de corte", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=Lab1_2, options=None):
